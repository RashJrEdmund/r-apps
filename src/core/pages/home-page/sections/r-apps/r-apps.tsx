...
const Projects: Project[] = [
  ...
  },
  {
    ...
    app_name: "R - TM",
    app_description:
      "A task manager application for creating, managing teams and completing project mile-stones.",
    app_url: "",
    is_live: false
  },
  {
  ...
  },
  {
    ...
    app_name: "R - Auth",
    app_description:
      "An authentication service and npm package for easily shipping auth features like login/register etc.",
    app_url: "",
    is_live: false
  }
];
